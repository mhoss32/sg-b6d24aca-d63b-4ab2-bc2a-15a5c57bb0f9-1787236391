...
export const useCaseDetails: Record<string, UseCaseDetail> = {
  "uc-01": {
    ...
    asIs: {
      ...
      markers: [
        { type: "pain", text: "Zach: Requires the most experienced systems programmer to trace dependencies from memory", stageIndex: 2 },
        { type: "pain", text: "Sage: Security gaps remain invisible until specifically searched for during audit", stageIndex: 1 },
        { type: "time", text: "Typically 2–3 days to complete remediation across large estate", stageIndex: 2 },
        { type: "pain", text: "Zach: DR environment patched last or forgotten entirely", stageIndex: 3 },
        { type: "pain", text: "Derek: Change records assembled from memory and email threads", stageIndex: 5 },
      ],
    },
    toBe: {
      title: "Desired Outcome",
      stages: [
        { name: "Detect", description: "Atlas surfaces security gaps from continuous monitoring proactively" },
        { name: "Assess", description: "AI-generated blast radius and impact analysis" },
        { name: "Plan", description: "Sequenced remediation plan with dependency resolution" },
        { name: "Execute", description: "Orchestrated apply with automated validation" },
        { name: "Verify", description: "Behavioral monitoring confirms no regression" },
        { name: "Document", description: "Complete audit trail generated automatically" },
      ],
      markers: [
        { type: "gain", text: "Zach: Minutes not days for impact analysis — topology map shows exact affected components", stageIndex: 1 },
        { type: "gain", text: "Sage: Security posture continuously monitored and visible in real-time", stageIndex: 0 },
        { type: "gain", text: "Zach: DR environment included in every remediation cycle automatically", stageIndex: 3 },
        { type: "skill", text: "Zach: Atlas replaces expert memory with queryable topology model", stageIndex: 2 },
        { type: "gain", text: "Derek: Named attribution and audit trail generated automatically", stageIndex: 5 },
      ],
    },
    capabilities: [
