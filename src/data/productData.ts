...
export const useCaseDetails: Record<string, UseCaseDetail> = {
      ...
      externalTouchpoints: [
        {
          type: "enrichment",
          product: "Concert4Z",
          title: "Concert4z enrichment touchpoint - configuration compliance behavior check",
        ...
        },
        {
          type: "enrichment",
          product: "Concert4Z",
          title: "Concert4z enrichment touchpoint - behavioral evidence in audit package",
        ...
        },
        {
          type: "handoff",
          product: "Terraform",
          title: "Terraform handoff - change history infrastructure evidence",
          steps: [
            {
              label: "Atlas produced",
              description: "Atlas has identified compliance gaps across RACF, Db2, and configuration layers. The assessment also requires infrastructure-layer evidence.",
            },
            {
              label: "Atlas directs",
              description: "For audit evidence covering z/OS infrastructure changes (LPAR reconfigurations, memory changes, storage allocations), Atlas queries the Terraform apply history for the audit period.",
            },
            {
              label: "Terraform returns",
              description: "Terraform's apply log — with timestamps, operator identities, plan outputs, and state diffs — is incorporated into the change history as the infrastructure-layer change evidence.",
            },
          ],
          stageIndex: 2,
        },
        {
          type: "handoff",
          product: "Terraform",
          title: "Terraform handoff - remediation apply as governance evidence",
          steps: [
            {
              label: "Atlas produced",
              description: "Atlas has identified compliance deviations requiring infrastructure-layer remediation (network topology, storage configuration, resource isolation changes under regulatory scope).",
            },
            {
              label: "Atlas directs",
              description: "The remediation is implemented through Terraform's plan-approve-apply workflow. Atlas expresses required changes as proposed modifications to relevant LPAR workspace HCL declarations.",
            },
            {
              label: "Terraform returns",
              description: "Terraform's apply record — with timestamp, approver identity, and state diff — is incorporated into Atlas's remediation evidence as proof that the infrastructure change was reviewed and approved before being applied.",
            },
          ],
          stageIndex: 4,
        },
        {
          type: "enrichment",
          product: "Terraform",
          title: "Terraform enrichment touchpoint - infrastructure baseline for compliance",
        ...
        },
        {
          type: "enrichment",
          product: "Terraform",
          title: "Terraform enrichment touchpoint - dual-layer change evidence in package",
    ...
    toBe: {
      ...
      externalTouchpoints: [
        ...
        },
        {
          type: "enrichment",
          product: "Bob PPZ",
          title: "Bobppz enrichment touchpoint - application dependency deep-dive",
        ...
        },
        {
          type: "enrichment",
          product: "Bob PPZ",
          title: "Bobppz enrichment touchpoint - change history orientation",
        ...
        },
        {
          type: "enrichment",
          product: "Terraform",
          title: "Terraform enrichment touchpoint - generate environment context",
        ...
        },
        {
          type: "enrichment",
          product: "Terraform",
          title: "Terraform enrichment touchpoint - task delegation",
  ...
  "uc-03": {
    ...
    toBe: {
      ...
      markers: [
        ...
        { persona: "Lupita", type: "time", title: "Time Saving — days to weeks → Atlas-orchestrated encryption workstream", description: "Encryption workstream orchestrated by Atlas — key management, encryption configuration, and dataset rewriting steps sequenced in the correct order with dependencies resolved.", stageIndex: 2 },
      ...
      externalTouchpoints: [
        {
          type: "handoff",
          product: "Concert4Z",
          title: "Concert4z handoff - anomaly-driven regulatory investigation",
          steps: [
            {
              label: "Concert4Z produced",
              description: "Concert4Z's Observe module has detected an access anomaly: a user or process accessing regulated data in a pattern that deviates from their historical norm — off-hours access, unusual dataset access volume, or a dormant privileged account becoming active.",
            },
            {
              label: "Concert4Z directs",
              description: "The anomaly triggers an Atlas regulatory investigation. Atlas scopes the affected regulated data components and assesses whether the anomaly represents a compliance gap requiring formal regulatory remediation.",
            },
            {
              label: "Atlas returns",
              description: "After Atlas completes the regulatory remediation, the remediation record is recorded in Atlas's continuous change record. Concert4Z sees the anomaly pattern resolved and can consume the Atlas remediation record as operational context for subsequent access monitoring.",
            },
          ],
          stageIndex: 0,
        },
        {
          type: "enrichment",
          product: "Concert4Z",
          title: "Concert4z enrichment touchpoint - behavioral access context",
        ...
        },
        {
          type: "enrichment",
          product: "Concert4Z",
          title: "Concert4z enrichment touchpoint - detect new regulated scope from access patterns",
          summary: "Atlas monitors for new regulated data and access control drift. Concert4Z's continuous access monitoring detects when regulated data is being accessed in ways configuration monitoring cannot catch — for example, a new program that begins accessing a regulated dataset without a corresponding configuration change — and surfaces it as a new regulated scope item for Atlas.",
          stageIndex: 5,
        },
        {
          type: "handoff",
          product: "Terraform",
          title: "Terraform handoff - infrastructure response plan",
          steps: [
            {
              label: "Atlas produced",
              description: "Atlas has identified infrastructure-layer changes required by the new regulation — network topology changes required by a data residency rule, or storage encryption configuration changes required by a new cryptographic standard.",
            },
            {
              label: "Atlas directs",
              description: "Required infrastructure changes are expressed as proposed modifications to the relevant LPAR or VM workspace HCL declarations and handed to the Terraform workflow for implementation via plan-approve-apply.",
            },
            {
              label: "Terraform returns",
              description: "Terraform apply records for each infrastructure-layer change. Atlas marks those items as implemented and incorporates the Terraform apply records into the response evidence.",
            },
          ],
          stageIndex: 2,
        },
        {
          type: "handoff",
          product: "Terraform",
          title: "Terraform handoff - implement infrastructure changes",
          steps: [
            {
              label: "Atlas produced",
              description: "Atlas tracks the Terraform apply status for each infrastructure change item in the regulatory response plan.",
            },
            {
              label: "Atlas directs",
              description: "When Terraform applies a change, Atlas receives confirmation and updates the response plan tracking. If Terraform detects a Sentinel/OPA policy violation, Atlas is informed and the response plan is updated.",
            },
            {
              label: "Terraform returns",
              description: "Terraform's apply and policy enforcement records form part of the documented regulatory response — including evidence of blocked changes that were rejected by policy.",
            },
          ],
          stageIndex: 3,
        },
        {
          ...
          product: "Terraform",
          title: "Terraform enrichment touchpoint - infrastructure baseline for compliance",
          summary: "Terraform's state file provides the authoritative record of the current declared infrastructure configuration. For infrastructure-layer compliance dimensions, Terraform's state is the ground truth for Atlas's gap assessment.",
          stageIndex: 1,
        },
        {
          type: "enrichment",
          product: "Terraform",
          title: "Terraform enrichment touchpoint - infrastructure change evidence",
          summary: "The regulatory compliance evidence package is enriched by Terraform's apply history for infrastructure-layer response items — immutable logs that demonstrate each change was reviewed and approved before being applied.",
          stageIndex: 4,
        },
        {
          type: "handoff",
          product: "Bob PPZ",
          title: "Bobppz handoff - application code remediation",
          steps: [
            {
              label: "Atlas produced",
              description: "Atlas has sequenced the full regulatory remediation workstream and identified items that require application code modification — masking logic, credential handling updates, data access restructuring, or audit trail hooks in programs that process regulated data.",
            },
            {
              label: "Atlas directs",
              description: "Atlas presents each application code remediation item with affected program(s), regulatory requirement, and scope context, and directs the developer to Bob PPZ. In Bob PPZ, ZUnderstand locates the specific code constructs that handle regulated fields and provides a safe implementation path.",
            },
            {
              label: "Bob PPZ returns",
              description: "Remediated code artifacts for each application program. Atlas validates them in an isolated test environment, confirms the compliance requirement is met, and records the code changes in the remediation evidence package.",
            },
          ],
          stageIndex: 2,
        },
        {
          type: "enrichment",
          product: "Bob PPZ",
          title: "Bobppz enrichment touchpoint - regulated scope precision",
          summary: "Bob PPZ's ZUnderstand data enriches Atlas's regulated data scope identification with application-level precision, narrowing scope from 'Application X processes regulated data' to specific programs and fields that match the regulation's PII definition.",
          stageIndex: 0,
        },
        {
          type: "enrichment",
          product: "Bob PPZ",
          title: "Bobppz enrichment touchpoint - access path coverage",
          summary: "When Atlas maps access control gaps, Bob PPZ's application topology enriches scope with code-level access paths — including dynamic calls and indirect references — preventing underestimation of the access control gap for complex applications.",
          stageIndex: 1,
        },
      ],
    },
      ...
      externalTouchpoints: [
        {
          type: "handoff",
          product: "Concert4Z",
          title: "Concert4z handoff - trigger health assessment from risk signal",
          steps: [
            {
              label: "Concert4Z produced",
              description: "Concert for Z's Risk Management module has detected an operational risk: a certificate approaching expiry, a cluster of missing critical maintenance, or a capacity threshold approaching ahead of a peak event.",
            },
            {
              label: "Concert4Z directs",
              description: "This risk flag triggers an Atlas health assessment workflow scoped to the affected components. Concert4Z's detection is specific; Atlas's assessment is comprehensive.",
            },
            {
              label: "Atlas returns",
              description: "Atlas returns a structured health assessment artifact. Concert4Z's Risk Management sees the operational risk addressed when Atlas's remediation is complete.",
            },
          ],
          stageIndex: 0,
        },
        {
          type: "enrichment",
          product: "Concert4Z",
          title: "Concert4z enrichment touchpoint - production behavior for constraints",
        ...
        },
        {
          type: "enrichment",
          product: "Concert4Z",
          title: "Concert4z enrichment touchpoint - incident history for severity",
        ...
        },
        {
          type: "enrichment",
          product: "Concert4Z",
          title: "Concert4z enrichment touchpoint - behavioral baseline for drift",
        ...
        },
        {
          type: "handoff",
          product: "Terraform",
          title: "Terraform handoff - infrastructure readiness gate",
          steps: [
            {
              label: "Atlas produced",
              description: "Atlas surfaces the infrastructure readiness check as a gate item: the target LPAR should be confirmed in its declared Terraform state before the change is authorised.",
            },
            {
              label: "Atlas directs",
              description: "The team runs terraform plan against the LPAR's workspace to confirm zero infrastructure drift.",
            },
            {
              label: "Terraform returns",
              description: "Terraform plan output. Atlas records the infrastructure readiness confirmation in the health assessment output. A clean plan confirms infrastructure readiness; any planned changes surface drift that must be resolved before the change proceeds.",
            },
          ],
          stageIndex: 2,
        },
        {
          type: "handoff",
          product: "Terraform",
          title: "Terraform handoff - post-change infrastructure validation",
          steps: [
            {
              label: "Atlas produced",
              description: "If infrastructure-layer changes were made as part of the change, Atlas directs confirmation that Terraform's apply completed successfully.",
            },
            {
              label: "Atlas directs",
              description: "Atlas confirms the post-change state matches the updated Terraform declaration.",
            },
            {
              label: "Terraform returns",
              description: "Terraform apply confirmation is incorporated into the post-change record.",
            },
          ],
          stageIndex: 5,
        },
        {
          type: "enrichment",
          product: "Terraform",
          title: "Terraform enrichment touchpoint - infrastructure baseline data",
        ...
        },
        {
          type: "enrichment",
          product: "Terraform",
          title: "Terraform enrichment touchpoint - readiness decision context",
        ...
        },
        {
          type: "handoff",
          product: "Bob PPZ",
          title: "Bobppz handoff - remediate application code findings",
          steps: [
            {
              label: "Atlas produced",
              description: "Atlas has generated the health assessment, ranked findings by severity, and identified compound risks. For findings whose root cause lies in application code — a deprecated API still in use, inefficient SQL creating a performance constraint, or a shared copybook creating a coupling risk — Atlas identifies the application component but cannot execute the code-level fix.",
            },
            {
              label: "Atlas directs",
              description: "Atlas presents the application-code finding with affected program identified, health check context, and blast radius. The user is directed to Bob PPZ to understand the code-level root cause and safe remediation path.",
            },
            {
              label: "Bob PPZ returns",
              description: "A code fix artifact. Atlas validates the fix in the provisioned environment, confirms the finding is resolved, and marks it closed in the health assessment record.",
            },
          ],
          stageIndex: 4,
        },
  ...
  "uc-07": {
    ...
    asIs: {
      ...
      markers: [
        // Step 1 — Assess Impact
        {
          persona: "Kathleen",
          type: "time",
          title: "Lost Time — half a day to 2 days of informal impact investigation",
          description: "Impact analysis is informal — developers rely on tribal knowledge, ask Zach or experienced colleagues, or discover impact in integration testing when it is already expensive to fix.",
          stageIndex: 0,
        },
        {
          persona: "Deb",
          type: "skill",
          title: "Skill Gap / Bottleneck — Deb cannot independently assess impact",
          description: "As an early-tenure developer, Deb has no tribal knowledge to draw on — she is most exposed to unknowingly making changes that have hidden impact.",
          stageIndex: 0,
        },
        {
          persona: "Kathleen",
          type: "pain",
          title: "Business Impact — incomplete impact assessments cause production incidents",
          description: "No tool joins application topology awareness with code-level impact analysis — the impact picture is assembled from CSD exports, Db2 catalog queries, and developer memory, and is routinely incomplete.",
          stageIndex: 0,
        },
        ...
        // Step 2 — Provision Environment
        {
          persona: "Deb",
          type: "time",
          title: "Lost Time — hours to 2 days waiting for a test environment",
          description: "Test environments are provisioned manually by the infrastructure team. Wait times range from hours to days. Filing a ticket and waiting blocks development flow.",
          stageIndex: 1,
        },
        {
          persona: "Kathleen",
          type: "pain",
          title: "Business Impact — shared, non-representative environments create false confidence",
          description: "Sandboxes that mirror the production topology are rare — most developers test against shared environments that may not reflect production behavior, leading to missed regressions.",
          stageIndex: 1,
        },
        {
          persona: "Zach",
          type: "skill",
          title: "Skill Gap / Bottleneck — Zach is the bottleneck for every test environment",
          description: "Every test environment provisioning request requires Zach's review and involvement — adding to his workload while blocking developers.",
          stageIndex: 1,
        },
        ...
        // Step 3 — Code
        {
          persona: "Deb",
          type: "skill",
          title: "Skill Gap / Bottleneck — Deb lacks self-service performance visibility",
          description: "Developers have no visibility into application performance metrics without going through the infrastructure team — no self-service performance baseline.",
          stageIndex: 2,
        },
        {
          persona: "Kathleen",
          type: "pain",
          title: "Business Impact — regressions surface late in integration testing or production",
          description: "Regression detection is ad hoc — if a change breaks something in a shared CICS transaction chain, it surfaces in integration testing or production, not during Deb's own development cycle.",
          stageIndex: 2,
        },
        ...
        // Step 4 — Generate Test Plan
        {
          persona: "Kathleen",
          type: "time",
          title: "Lost Time — 2–4 hours manual test plan generation per significant change",
          description: "Test plan generation is manual — Kathleen writes test scenarios based on her own knowledge of what the change touches, with no automated scope generation.",
          stageIndex: 3,
        },
        {
          persona: "Deb",
          type: "pain",
          title: "Business Impact — test coverage depends on individual developer discipline",
          description: "Test coverage is inconsistent and dependent on individual developer discipline — there is no automated scaffolding for what needs to be tested for a given change.",
          stageIndex: 3,
        },
        ...
        // Step 5 — Validate
        {
          persona: "Deb",
          type: "time",
          title: "Lost Time — half a day to 2 days of manual test execution per change",
          description: "There is little or no test automation on z/OS — test coverage is manual, inconsistent, and depends on individual developer discipline.",
          stageIndex: 4,
        },
        {
          persona: "Deb",
          type: "pain",
          title: "Business Impact — regressions caught outside the developer’s own cycle",
          description: "Regressions are caught in integration testing or production — the developer finds out she broke something through a test failure she did not control or a production incident.",
          stageIndex: 4,
        },
        {
          persona: "Kathleen",
          type: "time",
          title: "Lost Time — hours coordinating CICS/IMS deployment after validation",
          description: "Deploying an application change to CICS or IMS after validation requires multiple manual steps across multiple tools and teams — IBM Z Open Editor, DBB, deployment tools, and a sysprog to adjust CICS or IMS definitions.",
          stageIndex: 4,
        },
        ...
        // Step 6 — Deploy
        {
          persona: "Kathleen",
          type: "skill",
          title: "Skill Gap / Bottleneck — sysprog oversight required for every configuration-affecting deployment",
          description: "Deploying to CICS or IMS requires multiple manual steps across multiple tools and teams — developer cannot deploy independently if any configuration changes are involved, and Zach must be involved for definition updates.",
          stageIndex: 5,
        },
        {
          persona: "Deb",
          type: "skill",
          title: "Skill Gap / Bottleneck — Deb has no visibility into configuration changes her code triggers",
          description: "Deb has no visibility into what configuration changes her code triggers — the handoff to sysprog is opaque from her perspective, and she cannot initiate deployment independently.",
          stageIndex: 5,
        },
      ],
    },
    toBe: {
      title: "Desired Outcome",
      stages: [
        { name: "Assess Impact", description: "Atlas identifies affected programs, tables, transactions, and dependencies in seconds before any code is written." },
        { name: "Provision Environment", description: "Isolated test environment is provisioned in the background while the developer writes code." },
        { name: "Code", description: "Developer writes code in their IDE with Atlas context available in real time." },
        { name: "Generate Test Plan", description: "Atlas generates a test plan scoped to the actual change automatically." },
        { name: "Validate", description: "Automated test execution with failure attribution in an isolated environment owned by the developer." },
        { name: "Deploy", description: "Atlas orchestrates CICS/IMS deployment; developer initiates, Atlas handles configuration steps with governance gates." },
      ],
      markers: [
        // Step 1 — Assess Impact (wows)
        {
          persona: "Kathleen",
          type: "time",
          title: "Time Saving — half a day to 2 days → seconds for impact assessment",
          description: "Ask Atlas what the proposed change will touch and receive a full answer across CICS, Db2, MQ, and z/OS Connect in seconds, before any code is written.",
          stageIndex: 0,
        },
        {
          persona: "Deb",
          type: "gain",
          title: "New User Capability — Deb understands change scope before coding",
          description: "Atlas provides the system context Deb does not yet carry — she understands the scope of her change before making it, not after breaking something.",
          stageIndex: 0,
        },
        {
          persona: "Angie",
          type: "skill",
          title: "Atlas AI & Automation — impact analysis grounded in architecture and topology",
          description: "Impact analysis references both the live application topology and Angie’s architectural specification — changes are validated against architectural intent as well as dependencies.",
          stageIndex: 0,
        },

        // Step 2 — Provision Environment (wows)
        {
          persona: "Deb",
          type: "time",
          title: "Time Saving — hours to 2 days of waiting → background provisioning",
          description: "Test environment is provisioned in the background while Deb writes code — no ticket, no wait time; isolated environment is ready when she needs it.",
          stageIndex: 1,
        },
        {
          persona: "Kathleen",
          type: "gain",
          title: "New User Capability — production-representative sandbox on demand",
          description: "Isolated environment that mirrors the production topology for the application scope — no testing in a shared environment that hides regressions.",
          stageIndex: 1,
        },
        {
          persona: "Zach",
          type: "time",
          title: "Time Saving — sysprog no longer the bottleneck for developer environments",
          description: "Atlas handles background provisioning; Zach’s role shifts from manually fulfilling every request to setting guardrails and approving templates.",
          stageIndex: 1,
        },
        ...
        // Step 3 — Code (wows)
        {
          persona: "Deb",
          type: "gain",
          title: "New User Capability — on-demand topology context while coding",
          description: "Real-time topology context available while coding — any question about what a code path touches is answerable without interrupting a colleague.",
          stageIndex: 2,
        },
        {
          persona: "Kathleen",
          type: "time",
          title: "Time Saving — less mentoring time per change while maintaining safety",
          description: "Kathleen can delegate routine changes to Deb with confidence — Atlas provides the guardrails Kathleen would otherwise provide herself.",
          stageIndex: 2,
        },

        // Step 4 — Generate Test Plan (wows)
        {
          persona: "Kathleen",
          type: "time",
          title: "Time Saving — 2–4 hours → automatic test plan generation",
          description: "Test plan is generated automatically from the impact analysis — scenarios are scoped to the transactions and API paths the change touches.",
          stageIndex: 3,
        },
        {
          persona: "Deb",
          type: "gain",
          title: "New User Capability — topology-derived test coverage at Kathleen’s standard",
          description: "Deb’s test plan is as thorough as Kathleen’s because it comes from the same Atlas model, not from Deb’s current knowledge level.",
          stageIndex: 3,
        },
        {
          persona: "Kathleen",
          type: "skill",
          title: "Atlas AI & Automation — continuous test plan evolution as code changes",
          description: "As code evolves and touches more components than initially anticipated, Atlas automatically updates the test plan to include the new scenarios.",
          stageIndex: 3,
        },

        // Step 5 — Validate (wows)
        {
          persona: "Deb",
          type: "gain",
          title: "New User Capability — developer-controlled regression testing",
          description: "Developer-controlled regression testing in an isolated environment — regressions are caught in Deb’s own cycle before the change reaches integration testing or production.",
          stageIndex: 4,
        },
        {
          persona: "Deb",
          type: "gain",
          title: "New User Capability — fast change–test–iterate loop without infrastructure tickets",
          description: "Deb modifies code, watches the test plan update, and re-runs tests in a fast loop without filing tickets or waiting for infrastructure.",
          stageIndex: 4,
        },
        {
          persona: "Kathleen",
          type: "skill",
          title: "Atlas AI & Automation — failure attribution and summarized results",
          description: "Test results surface with failure attribution — which dependency or change caused the failure — so Kathleen reviews a structured pass/fail report, not raw log output.",
          stageIndex: 4,
        },
        ...
        // Step 6 — Deploy (wows)
        {
          persona: "Kathleen",
          type: "time",
          title: "Time Saving — hours of multi-tool handoff → Atlas-orchestrated deployment",
          description: "Atlas-orchestrated deployment to CICS or IMS — developer initiates; Atlas handles the configuration steps, with Zach authorizing changes that require sysprog oversight.",
          stageIndex: 5,
        },
        {
          persona: "Deb",
          type: "gain",
          title: "New User Capability — deployment visibility and participation",
          description: "Deployment is visible from Deb’s perspective — she can track status and understand each step without depending on a sysprog to relay progress.",
          stageIndex: 5,
        },
        {
          persona: "Zach",
          type: "skill",
          title: "Atlas AI & Automation — guardrail-driven self-service for routine changes",
          description: "For routine, guardrail-approved changes, Atlas executes deployment steps within policy — Zach focuses on defining guardrails and handling exceptional cases rather than every deployment.",
          stageIndex: 5,
        },
      ],
      externalTouchpoints: [
        {
          type: "handoff",
          product: "Bob PPZ",
          title: "Assess Impact to Code",
          steps: [
            { label: "Atlas produced", description: "Atlas has produced a complete blast radius assessment with affected programs, transactions, and data resources." },
            { label: "Atlas directs", description: "Developer opens affected programs in Bob PPZ with full context — ZUnderstand enriches Atlas’s impact analysis with code-level behavior and business rules." },
            { label: "Bob PPZ returns", description: "The completed code change artifact is returned to Atlas for validation and promotion." },
          ],
          stageIndex: 0,
        },
        {
          ...
          title: "Validate Test Failure",
          steps: [
            { label: "Atlas produced", description: "Atlas test execution surfaces a failure attributed to a specific program, call path, or SQL statement." },
            { label: "Atlas directs", description: "Failure context is passed to the developer in Bob PPZ — including affected program, transaction, and failure attribution details." },
            { label: "Bob PPZ returns", description: "A corrected code artifact is returned to Atlas; Atlas re-runs the relevant tests and updates the validation status." },
          ],
          stageIndex: 4,
        },
        {
          type: "handoff",
          product: "Bob PPZ",
          title: "Deploy Code Fix",
          steps: [
            { label: "Atlas produced", description: "During deployment validation, Atlas identifies an application code issue requiring a fix before production promotion." },
            { label: "Atlas directs", description: "Developer adjusts the code in Bob PPZ with full Atlas context for the deployment step that failed." },
            { label: "Bob PPZ returns", description: "An updated artifact is returned to Atlas; Atlas re-validates and resumes deployment orchestration." },
          ],
          stageIndex: 5,
        },
        {
          type: "enrichment",
          product: "Bob PPZ",
          title: "Impact Analysis Precision",
          summary: "ZUnderstand metadata enriches Atlas’s blast radius with code-level precision — execution paths, business rules, and coupling scores for the programs involved in the change.",
          stageIndex: 0,
        },
        {
          type: "enrichment",
          ...
          summary: "Test scenarios generated by Atlas are enriched with code-level execution path coverage for changed constructs, ensuring regression coverage aligns with the actual code changes.",
          stageIndex: 3,
        },
        {
          type: "enrichment",
          product: "Bob PPZ",
          title: "IDE Context Continuity",
          summary: "Atlas context — specification, impact analysis, test plan — is available inside the developer’s IDE through Bob PPZ integration, eliminating manual copy-paste between tools.",
          stageIndex: 2,
        },
        {
          type: "enrichment",
          product: "Concert4Z",
          title: "Blast Radius Accuracy",
          summary: "ZEN runtime relationship data from Concert4Z distinguishes active call paths from dormant static relationships, making Atlas’s blast radius more accurate and focused.",
          stageIndex: 0,
        },
        {
          type: "enrichment",
          ...
          summary: "Production behavioral baselines from Concert4Z inform Atlas’s validation criteria — test results are compared against real production norms, not just theoretical expectations.",
          stageIndex: 4,
        },
        {
          type: "enrichment",
          product: "Concert4Z",
          title: "Post-Deploy Context",
          summary: "After deployment, Concert4Z’s incident and performance data uses Atlas’s change record as primary context for any regression or anomaly investigation.",
          stageIndex: 5,
        },
        {
          type: "handoff",
          ...
          title: "Provision Test Environment",
          steps: [
            { label: "Atlas produced", description: "Atlas generates the infrastructure specification for the test environment required by the change." },
            { label: "Atlas directs", description: "Terraform provisions LPAR resources from HCL configuration in an isolated workspace that mirrors production." },
            { label: "Terraform returns", description: "A provisioned test environment with infrastructure matching production; Atlas deploys the application components and executes tests." },
          ],
          stageIndex: 1,
        },
        {
          ...
          steps: [
            { label: "Atlas produced", description: "Promotion requires a next-stage environment or infrastructure changes for the target LPARs." },
            { label: "Atlas directs", description: "Terraform provisions or updates the stage environment according to the plan and tears down obsolete environments when appropriate." },
            { label: "Terraform returns", description: "Workspace lifecycle and apply logs provide an infrastructure-layer audit trail for the change record." },
          ],
          stageIndex: 5,
        },
        {
          type: "enrichment",
          product: "Terraform",
          title: "Impact Analysis Boundaries",
          summary: "Terraform workspace boundaries inform Atlas’s impact analysis — cross-workspace changes are flagged as elevated-risk due to governance and dependency boundaries.",
          stageIndex: 0,
        },
        {
          type: "enrichment",
          product: "Terraform",
          title: "Change Record",
          summary: "Terraform apply history provides the infrastructure-layer change record that Atlas incorporates into the overall governance and traceability record for the application change.",
          stageIndex: 5,
        },
      ],
    },
