    ...
    toBe: {
      ...
      externalTouchpoints: [
        ...
        },
        {
          ...
          summary: "Atlas answers environmental questions in natural language: topology, subsystem relationships, change history, risk profile. When Bob PPZ is installed, exploration goes deeper: ZUnderstand surfaces business rule explanations, data dictionary context, and semantic analysis of what the code actually does. A new developer who can ask Atlas what a program touches AND ask Bob PPZ what that program means reaches genuine application understanding in days rather than weeks.",
          stageIndex: 1,
        },
        {
          type: "enrichment",
          product: "Bob PPZ",
          title: "Bob PPZ Enrichment Touchpoint",
          summary: "Atlas proactively surfaces open risks in the new hire's area of ownership. For application-facing risks (deprecated API, tightly coupled code, undocumented business rules), the risk description is topology-level. When Bob PPZ is installed, the risk assessment is enriched with code-level context: the specific lines of code using a deprecated API, the data flow creating coupling risk, the business rules that must be understood before a change is safe. This makes the risk briefing actionable rather than informational.",
          stageIndex: 2,
        },
      ],
    },
